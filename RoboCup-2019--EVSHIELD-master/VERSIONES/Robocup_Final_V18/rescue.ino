    ...
    while (true) {
      ...
      switch (RE) {
        ...
        case 3:
          ...
          while (true) {
            ...
            if (digitalRead(3) == 0 && digitalRead(5) == 0) {
              ...
              if (digitalRead(3) == 1 && digitalRead(5) == 1 && RV == 1) H = 3;
              if (RV == 0)H = 2;
              switch (H) {
                case 1:
                  while (true) {
                ...
                case 3:
                  while (true) {
                    ...
                    delay(6000);
                    for (int l = 0; l < 4; l++) {
                      evshield.bank_a.motorRunUnlimited(SH_Motor_Both, SH_Direction_Forward, 80);
                      delay(1000);
                      evshield.bank_a.motorRunUnlimited(SH_Motor_Both, SH_Direction_Reverse, 80);
                      delay(1000);
        ...
        default:
          ...
          evshield.bank_b.motorStop(SH_Motor_1, SH_Next_Action_Float);
          evshield.bank_a.motorRunUnlimited(SH_Motor_1, SH_Direction_Reverse, 30);
          evshield.bank_a.motorRunUnlimited(SH_Motor_2, SH_Direction_Reverse, 40);
          break;
      }
    }
  }
